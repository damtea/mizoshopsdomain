...
{
    if(!empty($_GET['productcategories'])) 
{

$query="SELECT p.PRODUCT_ID, p.PRODUCT_NAME, p.PRODUCT_DATE, p.PRODUCT_DESC, p.PRODUCT_PRICE, p. PRODUCT_SP, p.PRODUCT_IMG, s.SELLER_COMPANY  FROM product As p, sellers As s,catproduct As cp, categories As c where p.SELLER_ID=s.SELLER_ID and c.CID=cp.CID and cp.CPID=p.CPID and c.CID=".$_GET['productcategories']."";
    ...
    <nav class="navbar navbar-expand-md py-0 bg-primary navbar-dark" style="background: inherit;">
      <div class="container">
        ...
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent"> 
          <a href="index" class="text-light"> Sell on Mizo Shops Domain </a> &nbsp;|&nbsp;
    ...
    <div class="py-3">
      ...
      while($product=mysqli_fetch_assoc($result))
      {
        ...
        echo "<div class='col-md-3 w-50 border'>"
          . "<a href='productdetails?productid=".$product['PRODUCT_ID']."&imagelink=".$product['PRODUCT_IMG']."'><img class='img-fluid d-block mb-4' style='left: 0; margin: auto; right: 0; max-height: 250px; position: ; top:0; width: auto;' src='".$product['PRODUCT_IMG']."'> </a>"
                . "<div class='caption text-center'>"
        ."<h5>".$product['PRODUCT_NAME']."</h5>"
                ."<p>".$product['PRODUCT_SP']."</p>"
                 ."<p>".$product['SELLER_COMPANY']."</p>"
        ."<div style='text-align:center'>"
                .'<a class="btn btn-primary py-2" href=""  id="cart" style="color: white;" data-item="'.$product['PRODUCT_ID'].'">Add to <i class="fa d-inline px-0 fa-cart-plus fa-lg"></i></a>'
                .'<a class="btn btn-success py-2" href="#">Buy</a>';
