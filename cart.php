...
$query="SELECT p.PRODUCT_ID, p.PRODUCT_NAME, p.PRODUCT_BRAND, p.PRODUCT_QTY, p.PRODUCT_DATE, p.PRODUCT_DESC, p.PRODUCT_PRICE, p.PRODUCT_SP, p.PRODUCT_IMG, c.CART_DATE, c.CART_QTY,s.SELLER_NAME FROM product As p, cart As c,sellers as s where p.PRODUCT_ID=c.PRODUCT_ID and s.SELLER_ID=p.SELLER_ID and c.CUSTOMER_ID='".$_SESSION['customer_id']."'";
          ...
          <div class="col-md-8 offset-md-2">
            <div class="row">
              <!--<div class="span9">-->
                  ...
                  <div class="col-md-12"> 
                      <h5> My Cart (<?php echo $_SESSION['cart'];?>) </h5>
                    <hr />
                    <?php
                    while($product=mysqli_fetch_assoc($result))
      {
                   echo '<div class="row">'
                    ."<div class='col-2'> <a href='productdetails?productid=".$product['PRODUCT_ID']."&imagelink=".$product['PRODUCT_IMG']."'><img class='img-fluid d-block mb-4' style='left: 0; margin: auto; right: 0; max-height: 250px; position: ; top:0; width: auto;' src='".$product['PRODUCT_IMG']."'> </a> </div>"
                    .'<div class="col-8">'
                         ...
                         ."<table>
                           <tr>    
                            ...
                            <td>".$product['SELLER_NAME']."</td>
                                ...
                                <tr>
                            <td> <h4>₹".$product['PRODUCT_SP']."</h4></td>
                            <td>₹<strike>".$product['PRODUCT_SP']."</strike></td>
                                </tr>
                                <tr>
                            <td> Available: </td>
                            ...
                            <td> Quantity: </td>
                            <td><select>";
                            $cartqty=(int)$product['CART_QTY'];
                            $qava=(int)$product['PRODUCT_QTY'];
                            while($cartqty<=$qava)
                            {
                            echo "<option>".$cartqty++."</option>";
                            }
                          echo "</select>
</td>
                            </tr>
                            ...
                            <td><button type='submit' class='btn btn-light'> REMOVE </button></td>
                            </tr>
                  ...
                  .'</div><hr />';
                    ...
                    <div class="text-right">
                        <a class='btn btn-light' href="index"> <b><< CONTINUE SHOPPING</b> </a> 
                    <a class='btn btn-warning text-light' href="purchase"><strong> PLACE ORDER </strong></a>
                    </div>
                    </div>
            ...
            <div class="col-md-3" id="title_message">
                <?php
                $sumquery="SELECT SUM(p.PRODUCT_SP) As total FROM product As p, cart As c where p.PRODUCT_ID=c.PRODUCT_ID and c.CUSTOMER_ID='".$_SESSION['customer_id']."'";
                $sum=mysqli_query($conn,$sumquery);
              $sums=mysqli_fetch_assoc($sum);
              $total=$sums['total'];
               ?>
                ...
                <table class="w-100">
                    <tr>
                        <td>Price (<?php echo $_SESSION['cart'];?> Item) </td>
                    ...
                    <tr>
                        ...
                        <td class="text-right text-success"><strong> FREE </strong></td>
                    </tr>
                </table>
                <hr />
                <table class="w-100">
