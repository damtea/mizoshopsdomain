...
if(!empty($_GET['productid']))
{
    ...
    $querys="SELECT * from product where PRODUCT_ID='$productid'";
    $results= mysqli_query($conn, $querys);
    $counts= mysqli_num_rows($results);
    if($counts == 1) {
     while($products=mysqli_fetch_assoc($results))
      {
    $_SESSION['productname']=$products['PRODUCT_NAME'];
     $_SESSION['productbrand']=$products['PRODUCT_BRAND'];
      $_SESSION['productdesc']=$products['PRODUCT_DESC'];
       $_SESSION['productprice']=$products['PRODUCT_PRICE'];
        $_SESSION['productsp']=$products['PRODUCT_SP'];
         $_SESSION['productqty']=$products['PRODUCT_QTY'];
          $_SESSION['productimg']=$products['PRODUCT_IMG'];
          $_SESSION['productdate']=date('d-M-Y h:m:s', strtotime($products['PRODUCT_DATE']));
    ...
    <nav class="navbar navbar-expand-md py-0 navbar-dark" style="background: inherit; background-color: #f46242;">
      <div class="container">
        ...
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent"> 
          <a href="index" class="text-light"> Hereus </a> &nbsp;|&nbsp;
        ...
        <div class="col-md-6">
          <div class="card text-dark p-5">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                       <?php echo '<img src="'.$_SESSION['productimg'].'">';
...
<!--                <div class="form-group"> <label>Product Name: <?php echo $_SESSION['productname'];?></label>
                  </div>
                <div class="form-group"> <label>Brand: <?php echo $_SESSION['productbrand'];?></label>
                </div>
                  <div class="form-group"> <label>Price: <?php echo $_SESSION['productprice'];?></label>
                   </div>
                  <div class="form-group"> <label>Selling Price: <?php echo $_SESSION['productsp'];?></label>
                   </div>
                  <div class="form-group"> <label>Quantity: <?php echo $_SESSION['productqty'];?></label>
                 </div>
                <div class="form-group"> <label>Description: <?php echo $_SESSION['productdesc'];?></label>
                </div>
                <div class="form-group"> <label>Upload Date: <?php echo $_SESSION['productdate'];?></label>
                </div>-->
<!--                               <div class="form-group"> <label>Product Name: <?php echo $_SESSION['productname'];?></label>-->
                        ...
                        <table>
                            ...
                            <tr>    
                            <td> Brand: </td>
                            <td><?php echo $_SESSION['productbrand'];?></td>
                            </tr>
                            <tr>    
                            <td> Price: </td>
                            <td><?php echo $_SESSION['productprice'];?></td>
                            </tr>
                            <tr>    
                            <td> Selling price: </td>
                            <td><?php echo $_SESSION['productsp'];?></td>
                            </tr>
                            <tr>    
                            <td> Upload Date: </td>
                            <td><?php echo $_SESSION['productdate'];?></td>
                            </tr>
                            <tr>    
                            <td> Description: </td>
                            <td><?php echo $_SESSION['productdesc'];?></td>
                            </tr>
                            <tr>    
                            <td> Quantity: </td>
                            <td><?php echo $_SESSION['productqty'];?></td>
                            </tr>
			...
			<strong> Success ! </strong> <span class="success-message">Product upload complete!</span>
                        
		</div>
                     <div class="form-group"> <a href="categories" class="btn btn-warning">Sell more products</a>
                </div>
                  </div>
